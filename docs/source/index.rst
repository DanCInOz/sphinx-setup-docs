...
A good, quick overview of Sphinx and how to set it up natively (using the OS python instead of a docker package) can be found at the following youtube `playlist <https://www.youtube.com/playlist?list=PLE72UCmIe7T9HewaqCUhKqiMK3LxYStjy>`_.
